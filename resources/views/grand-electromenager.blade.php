        ...
        <div class="products-grid">
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <a href="{{ route('produit-detail', 41 }}" class="btn">Détails</a>
                </div>
            </div>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <a href="{{ route('produit-detail', 43) }}" class="btn">Détails</a>
                </div>
            </div>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <a href="{{ route('produit-detail', 44) }}" class="btn">Détails</a>
                </div>
            </div>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <a href="{{ route('produit-detail', 45) }}" class="btn">Détails</a>
                </div>
            </div>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <a href="{{ route('produit-detail', 46) }}" class="btn">Détails</a>
                </div>
            </div>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <a href="{{ route('produit-detail', 47) }}" class="btn">Détails</a>
                </div>
            </div>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <a href="{{ route('produit-detail', 48) }}" class="btn">Détails</a>
                </div>
            </div>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <a href="{{ route('produit-detail', 49) }}" class="btn">Détails</a>
                </div>
            </div>
        </div>
    </main>
