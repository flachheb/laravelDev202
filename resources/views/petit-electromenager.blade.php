        ...
        <div class="products-grid">
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <a href="{{ route('produit-detail', 21) }}" class="btn">Détails</a>
                </div>
            </div>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <a href="{{ route('produit-detail', 22) }}" class="btn">Détails</a>
                </div>
            </div>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <a href="{{ route('produit-detail', 23) }}" class="btn">Détails</a>
                </div>
            </div>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <a href="{{ route('produit-detail', 24) }}" class="btn">Détails</a>
                </div>
            </div>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <a href="{{ route('produit-detail', 25) }}" class="btn">Détails</a>
                </div>
            </div>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <a href="{{ route('produit-detail', 26) }}" class="btn">Détails</a>
                </div>
            </div>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <a href="{{ route('produit-detail', 27) }}" class="btn">Détails</a>
                </div>
            </div>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <a href="{{ route('produit-detail', 28) }}" class="btn">Détails</a>
                </div>
            </div>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <a href="{{ route('produit-detail', 29) }}" class="btn">Détails</a>
                </div>
            </div>
        </div>
    </main>
