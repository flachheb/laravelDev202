            ...
            <div>
                <div style="background: white; padding: 30px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1); margin-bottom: 25px;">
                    ...
                    <div style="margin-bottom: 25px;">
                        ...
                        <p style="color: #555; line-height: 1.8;">
                            ...
                            {{ $data['company']['city'] }} {{ $data['company']['zip'] }}<br>
                ...
                <div style="background: white; padding: 30px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
                    ...
                    <div style="display: flex; gap: 15px;">
                        <a href="#" style="color: #3498db; text-decoration: none; font-weight: bold;">📘 {{ $data['social']['facebook'] }}</a>
                        <a href="#" style="color: #3498db; text-decoration: none; font-weight: bold;">📷 {{ $data['social']['instagram'] }}</a>
                        <a href="#" style="color: #3498db; text-decoration: none; font-weight: bold;">🐦 {{ $data['social']['twitter'] }}</a>
                        <a href="#" style="color: #3498db; text-decoration: none; font-weight: bold;">▶️ {{ $data['social']['youtube'] }}</a>
                    </div>
                </div>
            </div>
        </div>
