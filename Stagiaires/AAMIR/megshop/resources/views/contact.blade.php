...
<body>
                ...
                <div style="background: white; padding: 30px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1); margin-bottom: 25px;">
                    ...
                    <div style="margin-bottom: 25px;">
                        ...
                        <p style="color: #555;">
                            ...
                            <strong>Support :</strong> {{$data[contact][phone_gsupport]}}<br>
    ...
    <footer>
        ...
        <div class="footer-links">
            <a href="cgv.blade.php">CGV</a>
            <a href="contact.blade.php">Contact</a>
            <a href="#">Mentions Légales</a>
        </div>
        <p><strong>Email :</strong> {{$data[company][email]}} | <strong>Téléphone :</strong> {{$data[contact][phone_general]}}</p>
    </footer>
</body>
</html>
