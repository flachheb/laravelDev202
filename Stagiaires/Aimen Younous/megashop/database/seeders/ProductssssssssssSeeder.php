...
class ProductSeeder extends Seeder
{
    ...
    // {
    //     $data = json_decode(file_get_contents(database_path('data/products.json')), true);
    ...
    public function run(): void
{
    ...
    Product::create([
        ...
        'details' => 'LOrdinateur Portable Pro est conçu pour les professionnels qui exigent performance et mobilité.',
        'rating' => 4.5,
        'reviews' => 10
