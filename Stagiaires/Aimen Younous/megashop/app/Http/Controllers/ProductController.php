...
class ProductController extends Controller {
    ...
    function produit($cat,$id){
        $products = $this->getProduct();
        // collect ktchd array 3adiya o kthawlha l collection f laravel
        // $numbers = [1, 2, 3]; =>$numbers = collect([1, 2, 3]);
        // daba n9adro nkhedmo b des methode fhal map filter ...
        // firstWhere(key,value) kt9alb ela  awal value f array li key == value 
        $product = collect($products[$cat])->firstWhere("id",$id);
        return view("produit-detail",["product"=>$product]);
    }
}
?>