        ...
        <div class="products-grid">
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <a href="<?php echo e(route('produit.detail', 41)); ?>" class="btn">Détails</a>
                </div>
            </div>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <a href="<?php echo e(route('produit.detail', 42)); ?>" class="btn">Détails</a>
                </div>
            </div>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <a href="<?php echo e(route('produit.detail', 43)); ?>" class="btn">Détails</a>
                </div>
            </div>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <a href="<?php echo e(route('produit.detail', 44)); ?>" class="btn">Détails</a>
                </div>
            </div>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <a href="<?php echo e(route('produit.detail', 45)); ?>" class="btn">Détails</a>
                </div>
            </div>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <a href="<?php echo e(route('produit.detail', 46)); ?>" class="btn">Détails</a>
                </div>
            </div>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <a href="<?php echo e(route('produit.detail', 47)); ?>" class="btn">Détails</a>
                </div>
            </div>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <a href="<?php echo e(route('produit.detail', 48)); ?>" class="btn">Détails</a>
                </div>
            </div>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <a href="<?php echo e(route('produit.detail', 49)); ?>" class="btn">Détails</a>
                </div>
            </div>
        </div>
    </main>
...
</html><?php /**PATH C:\xampp\htdocs\tp laravel\laravelDev202\Stagiaires\saif benkaddour\megashop\resources\views/grand-electromenager.blade.php ENDPATH**/ ?>